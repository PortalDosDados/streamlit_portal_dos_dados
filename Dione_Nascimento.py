...
# Seção de Botões (YouTube e GitHub lado a lado)
col_btn1, col_btn2, col_vazia = st.columns([1, 1, 3])

with col_btn1:
    # Botão do YouTube (Seu código original, mantido)
    st.markdown("""
...
with col_btn2:
    # Botão do GitHub (Adicionado)
    st.markdown("""
    <a href='https://github.com/PortalDosDados' target='_blank'>
